...
| `METRICS_REPORTER` | `none` | `prometheus`, `datadog`, `otlp`, `statsd`, `dogstatsd` |
...
| `STATSD_HOST` | `localhost` | StatsD/DogStatsD server host |
| `STATSD_PORT` | `8125` | StatsD/DogStatsD server port |
| `STATSD_FLAVOR` | `TELEGRAF` | `ETSY`, `TELEGRAF`, `SYSDIG`, `DATADOG` |
